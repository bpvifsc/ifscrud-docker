...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $stmt = $pdo->prepare("INSERT INTO matriculas (alunos_id,cursos_id,disciplinas_id) VALUES (?,?,?)");

        if($stmt->execute([ $alunos_id,$cursos_id,$disciplinas_id  ])) {
                $stmt = null;
                header("location: matriculas-index.php");
            } else{
